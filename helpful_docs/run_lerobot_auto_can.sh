...
DO_FOLLOWER_CALIBRATE="${DO_FOLLOWER_CALIBRATE:-1}"
DO_LEADER_CALIBRATE="${DO_LEADER_CALIBRATE:-1}"
...
Options:
  ...
  --no-calibration        Skip follower and leader calibration.
  --skip-follower-cal     Skip follower calibration only.
  --skip-leader-cal       Skip leader calibration only.
  ...
  --calibrate-all         Run both calibrations before teleoperation. This is the default.
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --bitrate)
      ...
      ;;
    --no-calibration)
      DO_FOLLOWER_CALIBRATE=0
      DO_LEADER_CALIBRATE=0
      shift
      ;;
    --skip-follower-cal)
      DO_FOLLOWER_CALIBRATE=0
